                ...
                <div class="card-body">
                    <form class="row g-3" method="POST" action="{{route('recluso.create')}}">
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="inputDocument" name="inputDocument">
                        </div>
                        <div class="col-md-6">
                          <label for="inputCodeRecluso" class="form-label">Código de Recluso</label>
                          <input type="text" class="form-control" id="inputCodeRecluso" name="inputCodeRecluso">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="inputNumberCell" name="inputNumberCell">
                        </div>
                        <div class="col-md-4">
